...
#define kNEWSURL @"http://c.m.163.com/nc/article/headline/T1348654225495/%d-20.html"
...
@interface TeachController ()<NetworkEngineDelegate>
...
- (void)networkDidFinishLoading:(NetworkEngine *)engine withInfo:(id)info{
    ...
    NSArray *carousItem = dict[@"T1348654225495"];
