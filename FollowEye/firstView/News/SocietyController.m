...
#define kNEWSURL @"http://c.m.163.com/nc/article/headline/T1348648037603/%d-20.html"
...
@interface SocietyController ()<NetworkEngineDelegate>
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    UILabel *label = (UILabel *)[self.view viewWithTag:419];
    
    if ([users boolForKey:@"nightSwitch"])
    {
...
- (void)networkDidFinishLoading:(NetworkEngine *)engine withInfo:(id)info{
    ...
    NSArray *carousItem = dict[@"T1348648037603"];
