...
#define kNEWSURL @"http://c.m.163.com/nc/article/headline/T1370583240249/%d-20.html"
...
@interface OriginalController ()<NetworkEngineDelegate>
...
@implementation OriginalController
...
- (void)networkDidFinishLoading:(NetworkEngine *)engine withInfo:(id)info{
    ...
    NSArray *carousItem = dict[@"T1370583240249"];
